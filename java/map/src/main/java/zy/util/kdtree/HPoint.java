...
class HPoint {
    ...
    protected static double sqrdistInit(HPoint x, HPoint y) {
    ...
    protected static double sqrdist(HPoint x, HPoint y) {
        ...
        LngLat e = new LngLat(x.coord[0], x.coord[1]);
        LngLat s = new LngLat(y.coord[0], y.coord[1]);
        double dist = LatLonUtil.getDistance(s, e);
