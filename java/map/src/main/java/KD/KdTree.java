...
public class KdTree {
    ...
    public void insert(Point2D p) {
        ...
        root = insert(root, p, true, new double[] {Double.MIN_VALUE, Double.MIN_VALUE, Double.MAX_VALUE, Double.MAX_VALUE});
    }
    ...
    public static void main(String[] args) {
        ...
        Point2D p = new Point2D(4.0, 4.0);
        kdtree.insert(p);

        p = new Point2D(2.0, 2.0);
        kdtree.insert(p);

        p = new Point2D(3.0, 2.0);
        kdtree.insert(p);

        p = new Point2D(2.0, 3.0);
        kdtree.insert(p);

        p = new Point2D(3.0, 3.0);
        kdtree.insert(p);

        p = new Point2D(5.0, 4.0);
        kdtree.insert(p);

        p = new Point2D(4.0, 5.0);
        kdtree.insert(p);

        p = new Point2D(5.0, 5.0);
        kdtree.insert(p);

        //    public Iterable<Point2D> range(RectHV rect) {
        //double xmin, double ymin, double xmax, double ymax
        RectHV rect = new RectHV(2.0,3.0,5.0,5.0);
